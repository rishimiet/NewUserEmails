...
namespace UserEmails
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            ////pg.test(Console.ReadLine());
            ////pg.test1();
            //pg.versioningOfFile(@"D:\server\tomcat8\webapps\ROOT\stockage\stock\LDL-WILEY-PSSA-201900528\RT_Proof_Correction_Processing\\", @"D:\server\tomcat8\webapps\ROOT\stockage\stock\LDL-WILEY-PSSA-201900528\pssa-journal_c6bbf177-8866-4ead-81db-1908f4b43bd1.zip", "LDL-WILEY-PSSA-201900528");
            //return;
