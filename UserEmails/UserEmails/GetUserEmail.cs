...
namespace UserEmails
{
    public class GetUserEmail
    {
                ...
                for (int len = 0; len < al.Count; len++)
                {
                    ...
                    for (int i = count; i >= 1; i -= 1)
                    {
                        try
                        {
                            ...
                            //if (!msgSubject.Contains("RT Copyediting for pssb.201900485R1"))
                            //{
                            //    continue;
                            //}
                            ...
                            {                                
                                ...
                                if (sub.Contains("CDRF CAMS Content Delivery Request") && !fromMailID.ToLower().Contains("lumina") && (sub.Contains("_AM_")) && sub.StartsWith("LIVE") && ArticleID.Trim().StartsWith("LDL-"))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        try
                                        {
                                            Process processChild = Process.Start(@"D:\executor_portal\CupCamsProcees\CupCamsProcees.bat", ArticleID);
                                    ...
                                    {                                       
                                        ...
                                        if (volIssue != "" & vol.Trim() != "" && issue != "")
                                        {
                                            try
                                            {
                                                ...
                                                if (issueStageID.Trim() == "ISTM1001")
                                                {
                                                    ...
                                                    uploadZIPToFTP("camsftp.cambridge.org", "21", "luminad", "(n>2Uwc;?ZA`pqJ:", dPath + "\\ISSUECAMSDelivery\\FROM CUP\\" + ftpFileName, "//from_cams//" + ftpFileName, "none", "");
                                                        ...
                                                        if (!sub.ToLower().Contains("re-supply"))
                                                        {
                                                            if (dt1.Rows.Count == 1)
                                                            {
                                                                ...
                                                                if (stageID == "STM1012" || stageID == "STM1032")
                                                                {
                                                                    ...
                                                                    uploadZIPToFTP("camsftp.cambridge.org", "21", "luminad", "(n>2Uwc;?ZA`pqJ:", dPath + "\\CAMS Delivery\\FROM CUP\\" + ftpFileName, "//from_cams//" + ftpFileName, "none", dPath);
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        ...
                                                                        uploadZIPToFTP("camsftp.cambridge.org", "21", "luminad", "(n>2Uwc;?ZA`pqJ:", dPath + "\\CAMSDeliveryForOtherStage\\FROM CUP\\" + ftpFileName, "//from_cams//" + ftpFileName, "none", dPath);
                                        ...
                                        if (!path.ToLower().Contains("notfound") && moveToRP == true && !fromMailID.ToLower().Contains("lumina") && path.Contains("LDL-CUP-"))
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                {
                                                    string query1 = "select count(*) from ldl_trn_CUP_CAMSDetails c where c.PublisherID='P1031' and c.JournalID='" + articleDetails[2] + "' and c.ArticleID='" + articleDetails[3] + "'";
                                        ...
                                        if (publisher == "P1031" && !sub.Contains("CAMS Content Delivery") && !fromMailID.ToLower().Contains("lumina") && !recFrom.ToLower().EndsWith(".caps") && !fromMailID.Contains("cup.journals") && !fromMailID.Contains("cupproduction"))
                                        {
                                            ...
                                            if (msgSubject.Contains("REC") || msgSubject.Contains("INS") || mailbody.Contains("IPG") || mailbody.Contains("EAG") || mailbody.Contains("MSC") || mailbody.Contains("NWS") || mailbody.Contains("MDY") || mailbody.Contains("TLP") || mailbody.Contains("GMJ") || mailbody.Contains("XPS") || mailbody.Contains("AER") || mailbody.Contains("CTY"))
                                            {
                                            ...
                                            if (!path.Contains("NotFound\\") && (path.Contains("LDL-CUP-CTY-") || path.Contains("LDL-CUP-XPS-")))
                                            {
                                        ...
                                        if (!path.Contains("NotFound\\") && !fromMailID.ToLower().Contains("lumina") && (path.Contains("LDL-CUP-POL-") || path.Contains("LDL-CUP-BME-") || path.Contains("LDL-CUP-DOH-") || path.Contains("LDL-CUP-INS-") || path.Contains("LDL-CUP-REC-") || path.Contains("LDL-CUP-AER-") || path.Contains("LDL-CUP-CTY-") || path.Contains("LDL-CUP-XPS-") || path.Contains("LDL-CUP-NWS-") || path.Contains("LDL-CUP-REC-") || path.Contains("LDL-CUP-EAG-") || path.Contains("LDL-CUP-MDY-") || path.Contains("LDL-CUP-PAS-") || path.Contains("LDL-CUP-IPG-") || path.Contains("LDL-CUP-GMJ-") || path.Contains("LDL-CUP-EAG-") || path.Contains("LDL-CUP-MSC-") || path.Contains("LDL-CUP-NWS-") || path.Contains("LDL-CUP-TLP-")) && !recFrom.ToLower().EndsWith(".caps") && (mailId.ToLower().Contains("cup.journals@luminad.com") || mailId.ToLower().Contains("cupproduction@luminad.com") || mailId.ToLower().Contains("cup.caps@luminad.com")))                                        
                                        {
                                            ...
                                            foreach (MessagePart mpart in message.FindAllAttachments())
                                            {
                                                ...
                                                if (publisher == "P1031" && sub.Contains("First Proof-") && fileNameAttach.ToLower().Contains(".pdf"))
                                                {
            ...
            try
            {
                ...
                else
                {
                    if (dt1.Rows.Count == 1)
                    {
                        ...
                        string aID = dr1[1].ToString();
                        string pID = dr1[2].ToString();
                        UpdateQuery("Insert into ldl_trn_ArticleMovementRegister_CUP (publisherid,journalid,articleid, " + "stageid,starttime,status,remark,userid)  values ('P1031','" + jID + "','" + aID + "'" + ",'STM1052',getdate(),'STAGE-CHANGE','Mail received for AM CAMS SUPPLY','caps1')");
                        dt1 = GetDataFromDB("select foldercode from ldl_trn_parallelprocess_mapping  where foldercode='" + ArticleID + "'");
                        if (dt1.Rows.Count == 1)
                        {
                            UpdateQuery("Update ldl_trn_parallelprocess_mapping set stageid='STM1052' where foldercode='" + ArticleID + "'");
        ...
        public void updateForCAMSReceived(string ArticleID,string path,string jid,string aid)
        {
            try
            {
                File.Copy(path + "\\" + jid + "-" + aid + ".xml", path + "\\" + jid + "-" + aid + "_bk.xml",true);
            ...
            try
            {
                ...
                if (publisher == "P1032" && !fromMailID.ToLower().Contains(".caps") && mailId.ToLower().Contains("wiley.caps@luminad.com"))
                {
                    if (sub.Contains("Task Assignment") && ArticleID.ToUpper().Contains("LDL-") && mailbody.Contains("Dear Lumina Typesetter") && mailbody.ToLower().Contains("rt red"))
                    {
                        ...
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\Editor\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".zip", "//Input_folder/" + journalCode + "_" + GUID + ".zip", "none","");
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\Editor\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".go.xml", "//Input_folder/" + journalCode + "_" + GUID + ".go.xml", "none","");
                        //File.Copy("")
                    ...
                    else if (sub.Contains("Task Assignment - RT Proof Correction Processing") && ArticleID.ToUpper().Contains("LDL-WILEY-") && GUID != "" && mailbody.Contains("Please download the files"))
                    {
                        ...
                        UpdateQuery(dbQuery);
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".zip", "//Input_folder/" + journalCode + "_" + GUID + ".zip", "none", "");
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".go.xml", "//Input_folder/" + journalCode + "_" + GUID + ".go.xml", "none", "");
                    ...
                    else if (sub.Contains("Task Assignment - RT Proof Correction Processing") && ArticleID.ToUpper().Contains("LDL-WILEY-") && GUID != "" && mailbody.Contains("Please download the files"))
                    {
                        ...
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\AuthorCorrection\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".zip", "//Input_folder/" + journalCode + "_" + GUID + ".zip", "none", "");
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\AuthorCorrection\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".go.xml", "//Input_folder/" + journalCode + "_" + GUID + ".go.xml", "none", "");
                    ...
                    else if (sub.Contains("Task Assignment - RT Copyediting for") && ArticleID.ToUpper().Contains("LDL-WILEY-") && GUID != "" && mailbody.ToLower().Contains("upload"))
                    {
                        ...
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".zip", "//Input_folder/" + journalCode + "_" + GUID + ".zip", "none", "");
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\" + journalCode.Replace("solar-rrl", "solar-rrl") + "_" + GUID + ".go.xml", "//Input_folder/" + journalCode + "_" + GUID + ".go.xml", "none", "");
                        string dbquery = "update ldl_trn_articledetails set GUID_ce_reassigned='" + GUID + "' where publisherid='P1032' and journalid='" + folderCode[2] + "' and articleid='" + folderCode[3] + "';";
                        UpdateQuery(dbquery);
            ...
            try
            {
                ...
                if (publisher == "P1032" && !fromMailID.ToLower().Contains(".caps") && mailId.ToLower().Contains("wiley.caps@luminad.com"))
                {
                    if (sub.Contains("Task Assignment") && ArticleID.ToUpper().Contains("LDL-") && mailbody.Contains("Dear Lumina Typesetter") && mailbody.ToLower().Contains("rt accepted article"))
                    {
                        ...
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\" + journalCode + "_" + GUID + ".zip", "//Input_folder/" + journalCode + "_" + GUID + ".zip", "none","");
                        uploadZIPToFTP("ftp.luminadus.com", "21", "Wiley-caps", "Lumina@755", dirStartPath + ArticleID + "\\" + journalCode + "_" + GUID + ".go.xml", "//Input_folder/" + journalCode + "_" + GUID + ".go.xml", "none","");
        ...
        private void updateInXML(string fileName,string color)
        {
            try
            {
                if (File.Exists(fileName))
                {
                    ...
                    File.Move(fileName, fileName.Replace(".xml", "_bkup" + currentTime + ".xml"));
        ...
        private Boolean updationForCUPFirstProof(string publisher, string ArticleID)
        {
                    ...
                    ",'STM1013',getdate(),'STAGE-CHANGE','Article moved to Correction Queue as mail received.','caps1')");
                        ...
                        if (dt1.Rows.Count == 1)
                        {
                            ...
                            try
                            {
                                ...
                                Console.WriteLine("End for BluePencil");
                            }
                            catch { }
                        }
                        result = true;
   ...
   ",'"+stageid+"',getdate(),'SUBMITTED','','caps1')");
        ...
        public void uploadZIPToFTP(string host, string port, string user, string pass, string inPath, string ftpPath, string encryp,string dPath)
        {
